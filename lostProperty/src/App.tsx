...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-300 to-rose-400">
      ...
      <div className="bg-purpink-m border-purpink-d flex max-w-xl border-solid border-6 rounded-xl shadow-lg shadow-pink-950/40 px-3 py-4 mx-auto my-5">
      ...
      <div className="bg-purpink-m border-purpink-d max-w-md border-solid border-6 shadow-lg shadow-pink-950/40 rounded-xl px-3 py-4 mx-auto">
